...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function mostrarPersonajesEnTabla(personajes) {
        ...
        personajes.forEach(personaje => {
            ...
            fila.innerHTML = `
                <td>${personaje.id}</td>
                <td><img src="images/${personaje.imagenUrl}" alt="${personaje.nombre}" class="personaje-img"></td>
    ...
    function verPersonaje(id) {
        ...
        .then(([personaje, transformaciones, tecnicas, sagas]) => {
            ...
            document.getElementById("detallesImagen").src = `images/${personaje.imagenUrl}`;
